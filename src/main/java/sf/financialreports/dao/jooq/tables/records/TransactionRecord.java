...
public class TransactionRecord extends UpdatableRecordImpl<TransactionRecord> implements Record15<UUID, UUID, String, LocalDate, String, BigDecimal, TransactionStatus, String, String, UserType, String, String, String, String, LocalDateTime> {
    ...
    /**
     * Setter for <code>finances.transaction.user_id</code>. Идентификатор
     * пользователя
     */
    ...
    /**
     * Setter for <code>finances.transaction.category_name</code>. Идентификатор
     * категории
     */
    ...
    /**
     * Setter for <code>finances.transaction.date</code>. Дата совершения
     * транзакции
     */
    ...
    /**
     * Setter for <code>finances.transaction.description</code>. Описание
     * транзакции
     */
    ...
    /**
     * Setter for <code>finances.transaction.amount</code>. Сумма транзакции
     */
    ...
    /**
     * Setter for <code>finances.transaction.status</code>. Статус транзакции
     */
    ...
    /**
     * Setter for <code>finances.transaction.sender_bank</code>. Название
     * банка-отправителя
     */
    ...
    /**
     * Setter for <code>finances.transaction.sender_account</code>. Счет
     * отправителя
     */
    ...
    /**
     * Setter for <code>finances.transaction.receiver_user_type</code>. Тип
     * получателя
     */
    ...
    /**
     * Setter for <code>finances.transaction.receiver_bank</code>. Название
     * банка-получателя
     */
    ...
    /**
     * Setter for <code>finances.transaction.receiver_account</code>. Счет
     * получателя
     */
    ...
    /**
     * Setter for <code>finances.transaction.receiver_inn</code>. ИНН получателя
     */
    ...
    /**
     * Setter for <code>finances.transaction.receiver_phone</code>. Номер
     * телефона получателя
     */
    ...
    /**
     * Setter for <code>finances.transaction.created_at</code>. Дата создания
     * транзакции
     */
