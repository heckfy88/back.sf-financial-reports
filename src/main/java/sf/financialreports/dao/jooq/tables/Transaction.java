...
public class Transaction extends TableImpl<TransactionRecord> {
    ...
    /**
     * The column <code>finances.transaction.category_name</code>.
     */
    public final TableField<TransactionRecord, String> CATEGORY_NAME = createField(DSL.name("category_name"), SQLDataType.VARCHAR(100).nullable(false), this, "");
     ...
     */
    public final TableField<TransactionRecord, TransactionStatus> STATUS = createField(DSL.name("status"), SQLDataType.VARCHAR.nullable(false).asEnumDataType(sf.financialreports.dao.jooq.enums.TransactionStatus.class), this, "");
